...
```bash
curl -o /usr/bin/tactu_cpanel -s -L https://raw.githubusercontent.com/Ferojbd/cp-m/main/tactu_cpanel
...
```bash
curl -o /root/cpanel_update -s -L https://raw.githubusercontent.com/Ferojbd/cp-m/main/cpanel_update
...
```
[![install cPanel nulled](https://raw.githubusercontent.com/Ferojbd/cp-m/main/img/mqdefault.jpg)](https://youtu.be/A_h3KcRCogY?si=pzOP467P25qKk_4n "install cPanel nulled")
...
```bash
curl -s https://raw.githubusercontent.com/Ferojbd/cp-m/main/no_execute | bash
```
